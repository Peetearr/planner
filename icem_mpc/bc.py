...
def train_behavior_cloning(model, expert_observations, expert_actions, epochs=10000, batch_size=32, lr=1e-3):
...
if __name__ == "__main__":
    ...
    filenames = [y for x in os.walk(folder) for y in glob.glob(os.path.join(x[0], '*.pkl'))]
