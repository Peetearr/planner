...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def step(self, action, t):
        ...
        reward, done, info = self._post_action(action, t)

        return self._get_observations(), reward, done, info

    def mpc_step(self, state, action, t):
        
        
        state_backup=self.sim.get_state()
        ...
        self.sim.set_state(state_backup)
    ...
    def _post_action(self, action, t):
        """
